...
execute if score black Colour matches 1 run give @a[team=playing] black_wool
execute if score gray Colour matches 1 run give @a[team=playing] gray_wool
execute if score light_gray Colour matches 1 run give @a[team=playing] light_gray_wool
execute if score white Colour matches 1 run give @a[team=playing] white_wool
execute if score brown Colour matches 1 run give @a[team=playing] brown_wool
execute if score red Colour matches 1 run give @a[team=playing] red_wool
execute if score orange Colour matches 1 run give @a[team=playing] orange_wool
execute if score yellow Colour matches 1 run give @a[team=playing] yellow_wool
execute if score magenta Colour matches 1 run give @a[team=playing] magenta_wool
execute if score purple Colour matches 1 run give @a[team=playing] purple_wool
execute if score pink Colour matches 1 run give @a[team=playing] pink_wool
execute if score cyan Colour matches 1 run give @a[team=playing] cyan_wool
execute if score lime Colour matches 1 run give @a[team=playing] lime_wool
execute if score green Colour matches 1 run give @a[team=playing] green_wool
execute if score blue Colour matches 1 run give @a[team=playing] blue_wool
execute if score light_blue Colour matches 1 run give @a[team=playing] light_blue_wool
